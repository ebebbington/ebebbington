...
function displayPersonalDescription () {
    ...
    const description = '<strong>Hi! I am Edward Bebbington, aged ' + age + ', based in the UK, with a wide interest of many technologies and tools.</strong>'
    descriptionElem.innerHTML = description;
}

function displayCopyright() {
    const currentYear = new Date().getFullYear()
    document.getElementById('copyright').innerHTML = 'Copyright © ' + currentYear + ' Edward Bebbington'
}
