  ...
  it("cy.request() - make an XHR request", () => {
    ...
    cy.request("https://jsonplaceholder.cypress.io/comments")
      .should((response) => {
        ...
        expect(response.body).to.have.property("length").and.be.oneOf([
          500,
          501,
        ]);
  ...
  it("cy.request() - verify response using BDD syntax", () => {
    cy.request("https://jsonplaceholder.cypress.io/comments")
      .then((response) => {
        ...
        expect(response).property("body").to.have.property("length").and.be
          .oneOf([500, 501]);
  ...
  it("cy.request() - save response in the shared test context", () => {
    ...
    cy.request("https://jsonplaceholder.cypress.io/users?_limit=1")
      ...
      .then(function () {
        ...
        // Let's verify them.
        expect(this.post, "post has the right user id").property("userId").to
          .equal(this.user.id);
      });
  });
